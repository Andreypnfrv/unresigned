...
const ArbitalRedirectNotice = ({ onDismiss }: {
  ...
  const redirectHtml = <div>
    ...
    <p>Following the end of the <HoverPreviewLink href="/posts/kAgJJa3HLSZxsuSrf/arbital-postmortem">Arbital project</HoverPreviewLink>, the site's content has been integrated into the Unresigned wiki system, ensuring it is preserved for posterity.</p>
