...
export default registerMigration({
  ...
  action: async () => {
    ...
    for (const comment of oldReviewBotComments) {
      ...
      const manifoldUrl = comment.contents.html.match(/https:\/\/manifold.markets\/Unresigned\/([A-Za-z\d-])+/)?.[0];
